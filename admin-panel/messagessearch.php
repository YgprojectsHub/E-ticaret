<?php require_once "inc/header.php";?>
    ...
    <main class="app-content">
      ...
      <main class="row">
        ...
        $query = $db->prepare("SELECT * FROM mesajlar WHERE mesajisim LIKE :i OR mesajposta LIKE :p ORDER BY id DESC");
        $query->execute([":i" => '%'.$q.'%', ":p" => '%'.$q.'%' ]);
              ...
              <table class="table table-hover">
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $row['mesajdurum'] == 1 ? "<span class='badge badge-success'>Okundu</span>" : "<span class='badge badge-danger'>Okunmadı</span>"; ?></td>
                    <td>
        ...
        <div class="">
          <ul class="pagination">
            <?php
            if($total > $lim){
              pagination($s, ceil($total / $lim),"messagessearch.php?q=".$q."&s=");
            }
            ?>
          </ul>
        </div>
