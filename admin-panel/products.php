    ...
    <main class="app-content">
      ...
      <form action="<?php echo admin."/productssearch.php"; ?>" class="col-md-12" method="GET">
        ...
        <form action="" class="col-md-2" method="GET">
          <div class="form-group">
            <input type="text" name="blim" class="form-control" placeholder="Ürün listeleme sayısını giriniz">
          </div>
        </form>
        ...
        $query = $db->prepare("SELECT * FROM urunler INNER JOIN urun_kategoriler ON urun_kategoriler.id = urunler.urunkat ORDER BY urunler.id DESC");
        $query->execute();
        ...
        $query = $db->prepare("SELECT * FROM urunler INNER JOIN urun_kategoriler ON urun_kategoriler.id = urunler.urunkat ORDER BY urunler.id DESC LIMIT :show,:lim");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="Sil" href="<?php b2b("productdelete",$row["urunkodu"]); ?>"><i class="fa fa-close"></i></a>
                    </td>
                  </tr>
                <?php } ?>                  
                </tbody>
